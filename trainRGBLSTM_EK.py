...
import torch.optim
import torch
from utils.loaders import EpicKitchenDataset
import os
...
def main():
    ...
    train_loader = torch.utils.data.DataLoader(EpicKitchenDataset(split, ['EMG'],
    ...
    val_loader = torch.utils.data.DataLoader(EpicKitchenDataset(split, ['EMG'],
    ...
    net = LSTM(n_classes=n_classes,modality='EMG',input_size=160,hidden_size=80)
    net = net.to(device)
